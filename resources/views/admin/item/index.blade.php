        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Daftar Menu</h3>
                    <p class="text-subtitle text-muted">Berikut adalah daftar menu yang tersedia di restoran.</p>
                </div>
                        ...
                        <tbody>
                            @foreach ($items as $item)
                                <tr>
                                    ...
                                    <td><img src="{{ $item->img }}" width="60" class="img-fluid rounded-top"
                                            alt=""
                                    ...
                                    <td><span
                                            class="badge {{ $item->is_active ? 'bg-success' : 'bg-danger' }}">{{ $item->is_active ? 'Active' : 'Inactive' }}</span>
                                    </td>
